...
const Cards = ({name, img, extension}) => {
  ...
  const DeleteFavourites = title => {
    let favourite = JSON.parse (localStorage.getItem ('Favourites')) || [];
    let favoriteFilter = favourite.filter (el => el.name !== title);
